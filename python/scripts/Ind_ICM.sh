...
# 2: curiosity reward scaler
for ((i=1;i<=20;i++))
do
    python rl_bid_agent.py \
    --folder ICM3_${1}_c${2} \
    --ablation 12 --use_history 0 --history_type sar --norm_reward 0 --synchronous 1 --data_ver ${1} \
    --rev_scaler 1 --penalty 1 --agent sac --reward 5 --discount 1 \
    --fc1_hidden 40 --tau 0.1 --buffer_size 5000 --max_loss 30. --use_curiosity --curiosity_factor ${2} \
